...
# Lazy imports to avoid loading NASBench101 at module import time
def _get_encode_nb101():
    from nasbench.nas_bench_x11.encodings.encodings_nb101 import encode_nb101
    return encode_nb101

def _get_encode_nb201():
...
def encode(arch_strings, data, search_space, nlp_max_nodes, nb101_api):
    ...
    if search_space == 'nb201':
        encode_nb201 = _get_encode_nb201()
        ...
        encode_nb101 = _get_encode_nb101()
